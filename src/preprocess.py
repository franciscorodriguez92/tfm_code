...
#            text = self.replace_emoji
    ...
    def convert_hastags(self, text):
        return re.sub( r"([A-Z])", r" \1", text)
    
    def replace_exclamation(self, text):
    ...
    def replace_interrogation(self, text):
